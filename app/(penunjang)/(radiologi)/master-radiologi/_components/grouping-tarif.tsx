...
export default function GroupingDialog({
  ...
  const loadGroupingDetail = async () => {
    try {
      const url = `${APIURL}/rs/radiologi/group/${grouping.data?.id}/detail`;
  ...
  const handleHapus = async () => {
    try {
      const url = `${APIURL}/rs/radiologi/group/detail/${hapus.data?.id}`;
  ...
  const submitHandler: SubmitHandler<GroupingDPenunjangTarifTSchema> = async (
    ...
    try {
      e?.preventDefault();
      const url = `${APIURL}/rs/radiologi/group/detail`;
